 ...
 * @author wenfi
 */
public class UI_AddContact extends javax.swing.JFrame {
    int xMouse, yMouse;
    /**
     * Creates new form Conexion
     */
    public UI_AddContact() {
        initComponents();
    ...
    private void initComponents() {
        ...
        TxtAddContact.setFont(new java.awt.Font("Roboto Black", 0, 24)); // NOI18N
        TxtAddContact.setText("AGREGAR CONTACTO");
        bg.add(TxtAddContact, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 120, -1, -1));
        ...
        TxtEnter.setFont(new java.awt.Font("Roboto Condensed", 1, 18)); // NOI18N
        TxtEnter.setForeground(new java.awt.Color(255, 255, 255));
        TxtEnter.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        TxtEnter.setText("ENTRAR");
        TxtEnter.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        ...
        BtnEnterLayout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, BtnEnterLayout.createSequentialGroup()
                ...
                .addComponent(TxtEnter, javax.swing.GroupLayout.PREFERRED_SIZE, 120, javax.swing.GroupLayout.PREFERRED_SIZE))
        );
        ...
        bg.add(BtnEnter, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 390, 120, 40));
        ...
        BtnBack.setBackground(new java.awt.Color(7, 134, 184));

        TxtBack.setFont(new java.awt.Font("Roboto Condensed", 1, 18)); // NOI18N
        ...
        BtnBackLayout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, BtnBackLayout.createSequentialGroup()
                .addGap(0, 0, Short.MAX_VALUE)
                .addComponent(TxtBack, javax.swing.GroupLayout.PREFERRED_SIZE, 40, javax.swing.GroupLayout.PREFERRED_SIZE))
        );
        ...
        bg.add(BtnBack, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 50, 40, 40));
    ...
    private void TxtBackMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_TxtBackMouseClicked
        ...
        SwingUtilities.invokeLater(() -> {
            UI_Chat loginWindow = new UI_Chat();
    ...
    private void TxtBackMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_TxtBackMouseExited
        BtnBack.setBackground(new Color(7,134,184));
    ...
    private void TxtEnterMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_TxtEnterMouseClicked
        ...
        SwingUtilities.invokeLater(() -> {
            UI_Chat chatWindow = new UI_Chat();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UI_AddContact.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new UI_AddContact().setVisible(true);
            }
        });
    }
